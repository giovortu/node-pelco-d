...
PelcoD.prototype.extSetZoomSpeed = function(speed) {
    /*
     * speed = 0 to 3
     */
    ...
    var cmd2  = new Byte( 0x00 );
    var data1 = new Byte( 0x25 );
    var data2 = new Byte( 0x00 );


    this.bytes[3] = cmd2.get();
    this.bytes[3] = data1.get();
    this.bytes[3] = data2.get();
    return this;
};

PelcoD.prototype.extSetFocusSpeed = function(speed) {
    /*
     * speed = 0 to 3
     */
...
PelcoD.prototype.setZoomDir = function(dir) {
    /*
     * < 0  ... wide
     * > 0  ... tele
     * 0 stop
    ...
    // stop
    cmd2.off(5);  // right-bit;
    cmd2.off(6);  // left-bit;

    if (dir > 0) cmd2.on(5); // tele zoom
    if (dir < 0) cmd2.on(6); // wide zoom
